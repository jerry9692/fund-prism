...
def _latest_dynamic_attribution(
    ...
    return (
        {
            "calc_date": str(dyn.calc_date) if dyn.calc_date else None,
            "period_start": str(dyn.period_start),
            "period_end": str(dyn.period_end),
            "is_total": dyn.is_total,
            ...
            "benchmark_return": dyn.benchmark_return,
            "allocation_return": dyn.allocation_return,
            "selection_return": dyn.selection_return,
            "interaction_return": dyn.interaction_return,
            "bond_return": dyn.bond_return,
            "cash_return": dyn.cash_return,
            "convertible_bond_return": dyn.convertible_bond_return,
            "ipo_return": dyn.ipo_return,
            "invisible_return": dyn.invisible_return,
            "residual": dyn.residual,
            "residual_pct": dyn.residual_pct,
            "uses_simulated_holdings": dyn.uses_simulated_holdings,
            "benchmark_symbol": dyn.benchmark_symbol,
            "detail": dyn.detail,
